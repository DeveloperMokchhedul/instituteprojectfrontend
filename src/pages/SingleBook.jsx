...
const handleCart = (product) => {
  ...
  return (
    <>
      <h1 className="text-5xl font-bold uppercase text-center mt-[40px]">
      ...
      <div className="w-3/4 mx-auto grid grid-cols-12 gap-5 my-[100px] items-center">
        ...
        <div className="col-span-12 md:col-span-6">
          ...
          <button onClick={()=>handleCart(singleBook)} className="bg-red-400 px-2 py-1 rounded-md text-white mt-[20px] w-full">
            Add to Cart
          </button>
        </div>
      </div>
      ...
      <div className="w-2/4 mx-auto ">
        ...
        <div className="flex gap-10 items-center mt-[30px] justify-center">
          <div>
            <p>Name: {singleBook?.productOwner?.name}</p>
            <p>Email: {singleBook?.productOwner?.email}</p>
            <p>Phone: {singleBook?.productOwner?.phone}</p>
          </div>
          <div>
            <img
