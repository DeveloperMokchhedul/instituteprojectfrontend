...
function AddBook() {
    const [inputData, setInputData] = useState({
      ...
      const handleImageChange = (e) => {
        setProductImage(e.target.files[0]); // Get the selected file
      };
        ...
        <div className='h-screen flex justify-center items-center mt-10'>
          <div className='w-2/4 bg-white mx-auto p-5 rounded-md flex flex-col gap-y-5'>
            ...
            <div>
              ...
              <textarea name='description' onChange={handleChange} class="w-full p-2 border border-gray-300 rounded-md"></textarea>
